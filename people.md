...
<div class="prose-block">
  <h2>Professors</h2>
  <div class="people-directory">
    {% assign professors = site.people | where: "group", "Professor" | sort: "name" %}
...
<div class="prose-block">
  ...
  <div class="people-directory">
    {% assign associates = site.people | where: "group", "Associate Professor" | sort: "name" %}
...
<div class="prose-block">
  <h2>Postdocs</h2>
  <div class="people-directory">
    {% assign postdocs = site.people | where: "group", "Postdoc" | sort: "name" %}
...
<div class="prose-block">
  ...
  <div class="people-directory">
    {% assign phd_students = site.people | where: "group", "PhD Student" | sort: "name" %}
...
<div class="prose-block">
  ...
  <ul class="plain-list former-list">
    {% assign former_members = site.lab.people.former_members | sort: "name" %}
